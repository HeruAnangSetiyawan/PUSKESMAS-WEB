...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2020 at 07:53 PM
...
('K-02', 'Sunarya', 'Laki-Laki', '71816828738790', 'Majalengka', '18-08-1993', 'Tangerang', '2'),
...
('S-24', 'Maryudi', 'Laki-Laki', '71816838888718', 'Surabaya', '26-04-1988', 'Cengkareng', '2');
...
('2838938393', 'Joko', 'Laki-Laki', '822872181136', 'Cipedesa', '12-05-1999', 1, 2),
('3838918917', 'Sekar', 'Perempuan', '958593882899', 'Jakarta', '07-06-1995', 2, 3);
...
('0001', '2020-06-12-0001', '12345', '2020-06-12', 'S-24', '2', 'Mamank', 'Saudara Kandung', 'Cengkareng', 'Umum', '-'),
('0001', '2020-06-17-0001', '1234', '2020-06-17', 'K-02', '2', 'paiman', 'Saudara Kandung', 'tangerang', 'Umum', '-');
...
(13, 'Heru Anang Setiyawan', 'herruxc49@gmail.com', '$2y$04$0Z9UWL.79H6RtEBsZe2wqOSIXM6CM6eLhMxZMxmjtz7ePtvOyNXrm', '6281293889171_status_4d07d129f4304352a4cc9ef6e8234a9a.jpg', 1, 'y'),
(14, 'Mohamad fikriyansah taba', 'fikriyansah1@gmail.com', '$2y$04$gw1q06pOOmTft5FjYkuRDu/Xho8GAduHMorQfiPP8PX1fik57pWvy', 'patrickstar.jpg', 1, 'y'),
(15, 'Intannnia Hakim', 'intannniahakim08@gmail.com', '$2y$04$n2dzJVjEPZFFMnniiP0OJurIv/lRdZ89ZM7Lrk6Cu1y6ZkhdgpgXy', '', 1, 'y'),
(16, 'yuliya ulfah', 'ulfahyuliya99@gmail.com', '$2y$04$VvOaiKNN7OfKzpxY7yuATeGUJvtvE9RbH1I5Ub36RFneIsvQfF9am', '', 1, 'y'),
(17, 'Johannes Manalu', 'putrabatakmanaloe@gmail.com', '$2y$04$nXr/bFX/ZMNe02JBCetsC.4z2IQGA7a/4m8Ox1Fl2VhkW7NKcDmwC', '', 1, 'y');
...
--
ALTER TABLE `tbl_menu`
  MODIFY `id_menu` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `tbl_user_level`
  MODIFY `id_user_level` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
